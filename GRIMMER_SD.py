...
##    mod = importlib.import_module(str(i))
##    pattern_zero=mod.pattern_zero[:]
##    pattern_even=mod.pattern_even[:]
##    pattern_odd=mod.pattern_odd[:]
##    print i, len(pattern_even)+len(pattern_odd),(len(pattern_even)+len(pattern_odd))/float(i)
...
##    import importlib
##    mod = importlib.import_module(str(r))
...
for r in range(5,100):
    ...
    ave_places=2
##    for i in range(100):
    test=[random.randint(0,1) for k in range(r)]
...
##    if grimmer(std,places,r,'Population',mean,places)[1]!=1:
##        print grimmer(std,places,r,'Population',mean,places),test
